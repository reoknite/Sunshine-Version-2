...
public class TestSunshineService extends AndroidTestCase {
    ...
    /*
        ...
        This test is transferred from FetchWeatherTask which is a AsyncTask, when we use SunshineService
        instead. This test doesn't work as it is now. Might need mocking for getContentResolver().
     */
//    @TargetApi(11)
